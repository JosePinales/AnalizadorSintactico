...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case T_dato:
                    ...
                    break;
                case Resultado:
                    resultado += "  <Reservada Resultado>\t" + lexer.lexeme + "\n";
                    break;    
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        try {
            s.parse(); 
             Symbol sym = s.getS();
            //txtAnalizarSin.setText("Analisis realizado correctamente startling klk/n");
            txtAnalizarSin.setText("True " + (sym.value ));
